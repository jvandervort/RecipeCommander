...
import com.rednoblue.jRecipe.IO.Input.*;
...
public class AppFrame extends javax.swing.JFrame implements FileHistory.IFileHistory {
  ...
  /** file history for the file -> menu */
  ...
  private JasperCompiler j_compiler;

  /**
   *  Creates new form jrecipe
   */
  public AppFrame() {
    r_indexer = new RecipeIndexer();
    j_compiler = new JasperCompiler();
  ...
  private void initComponents() {
    ...
    pmiCutRec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X, java.awt.event.InputEvent.CTRL_MASK));
    ...
    pmiCopyRec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
    ...
    pmiPasteRec.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.CTRL_MASK));
    ...
    viewer_scroller.setViewportView(viewer);
    ...
    miNewRecipe.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_MASK));
   ...
   */
    ...
    private void miPasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miPasteActionPerformed
      ...
      pasteAction.actionPerformed(
              new ActionEvent(recipeTree, ActionEvent.ACTION_PERFORMED, (String) pasteAction.getValue(Action.NAME), EventQueue.getMostRecentEventTime(), 0));
    ...
    private void miCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCopyActionPerformed
      ...
      copyAction.actionPerformed(
              new ActionEvent(recipeTree, ActionEvent.ACTION_PERFORMED, (String) copyAction.getValue(Action.NAME), EventQueue.getMostRecentEventTime(), 0));
    ...
    private void miCutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCutActionPerformed
      ...
      cutAction.actionPerformed(
              new ActionEvent(recipeTree, ActionEvent.ACTION_PERFORMED, (String) cutAction.getValue(Action.NAME), EventQueue.getMostRecentEventTime(), 0));
	...
	private void openActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openActionPerformed
        ...
        public void setIcon() {
            ...
            setIconImage(Toolkit.getDefaultToolkit().createImage(getClass().getResource("/com/rednoblue/jRecipe/Images/appIcon.gif")));
    ...
    public boolean openBook(String path) {
      try {
        ...
        if (reader != null) {
          ...
          r_indexer.indexRecipes(book);
          return true;
        } else {
          LOGGER.severe("Couldn't create a reader.");
        }
    ...
    return false;
        ...
        private void searchFind(Collection fields, String queryString) {
            ...
            filter = r_indexer.searchRecipes(fields,queryString);
            if ( filter != null ) {
                BookUtils bw = new BookUtils(book);
                bw.loadJtree(this.recipeTree, this.viewBy, this.filter);
            }
  ...
  @Override
        ...
        public JasperPrint get_jasper_print(Recipe r) {
            ...
            try {
                ...
                BookUtils bw = new BookUtils(book, true);
                if ( r==null) {
                    ds = new JRXmlDataSource(XmlUtils.getBookXml(book, "jasper"), "/jRecipeBook/Recipe");
                    
                } else {
                    ds = new JRXmlDataSource(XmlUtils.getBookXml(book, r, "jasper"), "/jRecipeBook/Recipe");
                }
                Map<String,JasperReport> parameters = new HashMap<String,JasperReport>();
                parameters.put("IngredientSubreport", this.j_compiler.get_ingred_report());
                
                jasperPrint = JasperFillManager.fillReport(this.j_compiler.get_main_report(), parameters, ds);
    ...
    @Override
            public Transferable createTransferable(JComponent c) {
                ...
                if (node.isLeaf()) {
                    ...
                    return new RecipeTransferable(XmlUtils.getXmlString(XmlUtils.getBookXml(book, rec, "datamodel")) + "\n");
                } else {
            ...
            public boolean importData(JComponent comp,Transferable t) {
                ...
                try {
                    ...
                    if ( tbook.recipeCount() > 0 ) {
                        ArrayList rList = (ArrayList)tbook.getRecipes();
            ...
            public void valueChanged(TreeSelectionEvent e) {
              ...
              DefaultMutableTreeNode node = (DefaultMutableTreeNode) recipeTree.getLastSelectedPathComponent();
                if ( node != null && node.isLeaf()) {
                  ...
                  // you have a recipe
                  rec = (Recipe)nodeInfo;
                  if ( j_compiler.is_running() ) {
                    LOGGER.info("JasperComplier is still running");
                  } else {
                    ((MyJRViewer)viewer).setJasperPrint(get_jasper_print(rec));
                  }
                } else {
