...
public class Recipe {
	...
	/*
	 * public void setBook(Book arg) { this.book = arg; } public Book getBook() {
	 * return book; }
	 */
	...
	public String getIngredientList(String type, boolean htmlHeader) {
		...
		if (iList.size() > 0) {
			Iterator<Ingredient> it = iList.iterator();
	...
	public boolean equals(Object obj) {
		...
		Iterator<Ingredient> it1 = this.iList.iterator();
		Iterator<Ingredient> it2 = rec.iList.iterator();
		while (it1.hasNext()) {
